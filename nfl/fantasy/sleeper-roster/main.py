...
from repository import get_season_by_sleeper_season_id, upsert_podium_max
...
# global variables
sleeper_season_id: str = os.getenv("HOMIES_2024") or ""
if not sleeper_season_id:
...
maxes = get_club_maxes(sleeper_season_id)
if maxes is None:
    sys.exit()
...
success, season = get_season_by_sleeper_season_id(client, sleeper_season_id)
if not success:
    sys.exit()

elif season is None:
    print(f"No season record returned for sleeper season id: {sleeper_season_id}.")
    sys.exit()
